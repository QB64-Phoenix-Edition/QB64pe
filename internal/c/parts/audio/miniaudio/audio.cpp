...
//-----------------------------------------------------------------------------------------------------
// The following are directly copied from libqb.cpp and are here until we figure out a better way
// Probably some of this will have to moved to an header file that everything in the library can use
...
#define CLEAR_VARIABLE(_v_) memset(&(_v_), 0, sizeof(_v_))
