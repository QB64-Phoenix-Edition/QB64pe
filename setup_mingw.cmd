...
if "%ARCH%" == "ARM" (
    if %BITS% == 64 (
        set URL="https://github.com/mstorsjo/llvm-mingw/releases/download/20251202/llvm-mingw-20251202-ucrt-aarch64.zip"
        set MINGW_DIR=llvm-mingw-20251202-ucrt-aarch64
    ) else (
        set URL="https://github.com/mstorsjo/llvm-mingw/releases/download/20251202/llvm-mingw-20251202-ucrt-armv7.zip"
        set MINGW_DIR=llvm-mingw-20251202-ucrt-armv7
    )
) else (
    if %BITS% == 64 (
        set URL="https://github.com/mstorsjo/llvm-mingw/releases/download/20251202/llvm-mingw-20251202-ucrt-x86_64.zip"
        set MINGW_DIR=llvm-mingw-20251202-ucrt-x86_64
    ) else (
        set URL="https://github.com/mstorsjo/llvm-mingw/releases/download/20251202/llvm-mingw-20251202-ucrt-i686.zip"
        set MINGW_DIR=llvm-mingw-20251202-ucrt-i686
    )
)
