...
' This recomputes OFFSETTYPE/UOFFSETTYPE for the current TARGET_BITS
SUB RecalcTargetBitsTypes
    OFFSETTYPE = 64& + ISOFFSET + ISPOINTER: IF TARGET_BITS = 32 THEN OFFSETTYPE = 32& + ISOFFSET + ISPOINTER
    UOFFSETTYPE = 64& + ISOFFSET + ISUNSIGNED + ISPOINTER: IF TARGET_BITS = 32 THEN UOFFSETTYPE = 32& + ISOFFSET + ISUNSIGNED + ISPOINTER
END SUB

' We automatically call this at startup and then additionally if TARGET_BITS changes
RecalcTargetBitsTypes
