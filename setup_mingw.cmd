...
if "%ARCH%" == "ARM" (
    if %BITS% == 64 (
        set URL="https://github.com/mstorsjo/llvm-mingw/releases/download/20241015/llvm-mingw-20241015-ucrt-aarch64.zip"
        set MINGW_DIR=llvm-mingw-20241015-ucrt-aarch64
    ) else (
        set URL="https://github.com/mstorsjo/llvm-mingw/releases/download/20241015/llvm-mingw-20241015-ucrt-armv7.zip"
        set MINGW_DIR=llvm-mingw-20241015-ucrt-armv7
    )
) else (
    if %BITS% == 64 (
        set URL="https://github.com/mstorsjo/llvm-mingw/releases/download/20241015/llvm-mingw-20241015-ucrt-x86_64.zip"
        set MINGW_DIR=llvm-mingw-20241015-ucrt-x86_64
    ) else (
        set URL="https://github.com/mstorsjo/llvm-mingw/releases/download/20241015/llvm-mingw-20241015-ucrt-i686.zip"
        set MINGW_DIR=llvm-mingw-20241015-ucrt-i686
    )
)
